...
AgentBroko is made possible by open standards and open-source software.
...
- [Piper](https://github.com/rhasspy/piper): local neural text-to-speech. Engine and voice-model licenses may differ; verify both before use or redistribution.
- [eSpeak NG](https://github.com/espeak-ng/espeak-ng): local speech synthesis, distributed under GPL terms.
- Microsoft Windows System.Speech and Apple `say`: operating-system facilities governed by their respective platform terms.

## Development and distribution

- [Node.js](https://nodejs.org/) and [npm](https://www.npmjs.com/): optional CLI distribution.
- [pytest](https://pytest.org/): test framework, under the MIT License.
