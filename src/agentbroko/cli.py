...
SKILLS = {"video-forge": "Local video editing, offline narration, and captions"}

def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="agentbroko", description="AgentBroko local skills hub")
    parser.add_argument("--version", action="version", version=__version__)
    parser.add_argument("command", nargs="?", choices=["skills", "doctor", "video-forge"], default="skills")
